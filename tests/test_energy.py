...
class BalanceTests(unittest.TestCase):
    def test_with_baseline_and_payments(self):
        ...
        df = _make_df([{
            "Дата": "2026-04-15", "Поступление": 400,
    ...
    def test_mixed_payment_is_split_in_half(self):
        meters = {"5:2026:3": "0", "5:2026:4": "100"}
        df = _make_df([{
            "Дата": "2026-04-15", "Поступление": 800,
    ...
    def test_multi_plot_payment_split_proportionally(self):
        meters = {"5:2026:3": "0", "5:2026:4": "100"}
        df = _make_df([{
            "Дата": "2026-04-15", "Поступление": 600,
...
class ReconcileTests(unittest.TestCase):
    def test_basic(self):
        meters = {"5:2026:3": "0", "5:2026:4": "100"}
        df = _make_df([
            {"Дата": "2026-04-15", "Поступление": 500, "Списание": None,
             "Категория": "Электроэнергия (от садоводов)", "Участок": "5"},
            {"Дата": "2026-04-20", "Поступление": None, "Списание": 600,
