...
# Служебная категория-заглушка: в неё переносятся ячейки при удалении их
# категории (см. DetailWidget._on_delete_category в ui/detail_widget.py).
# Намеренно НЕ входит в ALL_CATEGORIES — не показывается в редакторе
# категорий и в выпадающем списке смены категории ячейки, только в
# фильтре (если такие ячейки реально есть) и как обычный цветной badge.
NO_CATEGORY_LABEL = "Без категории"
CATEGORY_COLORS[NO_CATEGORY_LABEL] = QColor(148, 148, 155)
